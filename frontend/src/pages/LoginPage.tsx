        ...
        <div className="flex flex-col justify-center px-8 py-10 sm:px-12 lg:px-14">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full rounded-lg bg-blue-600 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
